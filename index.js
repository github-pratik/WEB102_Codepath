...
gamesCard.innerHTML = `${totalGamesCount}`;
...
function filterFundedOnly() {
    ...
    // Log the funded games to the console to verify
...
console.log("Number of Unfunded Games (using reduce):", unfundedGamesCount);

// Total pledged amount and total number of games
const totalPledgedAmount = GAMES_JSON.reduce((total, game) => total + game.pledged, 0);
const totalGames = GAMES_JSON.length;

// create a string that explains the number of unfunded games using the ternary operator
const displayStr = `A total of $${totalPledgedAmount.toLocaleString()} has been raised for ${totalGames} games. Currently, ${unfundedGamesCount} game${unfundedGamesCount === 1 ? "" : "s"} remain unfunded. We need your help to fund these amazing games!`;
